  ...
  return (
    <>
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] rounded-full bg-cyan-300/30 mix-blend-multiply filter blur-[100px] animate-blob"></div>
        <div className="absolute top-[20%] right-[-10%] w-[35vw] h-[35vw] rounded-full bg-teal-300/30 mix-blend-multiply filter blur-[100px] animate-blob animation-delay-2000"></div>
        <div className="absolute bottom-[-20%] left-[20%] w-[45vw] h-[45vw] rounded-full bg-sky-300/30 mix-blend-multiply filter blur-[100px] animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="space-y-6 animate-fade-in-up relative z-10">
        ...
        <div className="glass-card rounded-3xl p-6 sm:px-8 border border-white/40 flex flex-wrap items-center justify-between gap-6 shadow-xl shadow-cyan-900/5">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/doctor-portal" className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-teal-500 to-emerald-500 text-white border border-teal-400/50 rounded-2xl text-sm font-semibold transition-all hover:shadow-lg hover:shadow-teal-500/40 hover:-translate-y-0.5">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zm-4 7a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
              Doctor Portal
            </a>
          </div>
        </div>
